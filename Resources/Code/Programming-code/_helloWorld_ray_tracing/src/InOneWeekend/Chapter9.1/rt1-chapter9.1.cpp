/**
 * @file rt1-chapter9.1.cpp
 * @brief This file contains the main entry point for a ray tracing program, based on the first book of the series.
 * ==============================================================================================
 * Extends previous 8 ray tracer program by 
 * - adding a simple diffuse material to the sphere that will be ray-traced, to simulate light bounces
 * ==============================================================================================
