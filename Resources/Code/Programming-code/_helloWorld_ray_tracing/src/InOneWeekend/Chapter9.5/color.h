...
/**
 * Converts a linear component to gamma space.
 *
 * @param linear_component The linear component to be converted.
 * @return The gamma space value of the linear component.
 */
