  ...
  private:
    ...
    color ray_color(const ray& r, int depth, const hittable& world) const 
    {
        ...
        if (world.hit(r, interval(0, infinity), rec))
        {
            ...
            // As a first demonstration of our new diffuse material we'll set the ray_color function to return 50% 
            // of the color from a bounce. We should expect to get a nice gray color.
