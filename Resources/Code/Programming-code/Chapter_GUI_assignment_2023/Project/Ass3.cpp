...
int main()
{
	...
	BackGround = new Graph_lib::Image(Point(0,0),"../../../../Chapter_GUI_assignment_2023/Project/images/Night.jpg");
	win = new Simple_window(Point(100,100),650,460,"Town of Salem");
	
	inBox = new In_box(Point(400,420),100,30,"Input");
	win->attach(*inBox);
	
	Submit = new Button(Point(500,420),50,30,"Submit",SubmitCallback);
	win->attach(*Submit);
	win->attach(*BackGround);


	/*Load players from file and print them*/
	Init("../../../../Chapter_GUI_assignment_2023/Project/Players.txt");
	ShowPlayers();
...
void ChangeBackground(){
	...
	BackGround = new Graph_lib::Image(Point(0,0),"../../../../Chapter_GUI_assignment_2023/Project/images/Day.jpg");
	win->attach(*BackGround);
...
void ShowPlayers(){
	...
	for(int i=0;i<players.size();i++){
		...
		if(players[i]->GetRole()=="Civilian")
			im = new Image(Point(xx,yy),"../../../../Chapter_GUI_assignment_2023/Project/images/Civilian.jpg");
		else if(players[i]->GetRole()=="Gangster")
			im = new Image(Point(xx,yy),"../../../../Chapter_GUI_assignment_2023/Project/images/Gangster.jpg");
		else
			im = new Image(Point(xx,yy),"../../../../Chapter_GUI_assignment_2023/Project/images/Doctor.jpg");
